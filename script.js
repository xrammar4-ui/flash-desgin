...
const CHAT_THEMES = [
  ...
  /* —— صباح / نهار أنمي —— */
  { id: 'm01', label: { en: 'Sakura Path', ar: 'طريق ساكورا' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1522383225653-ed111181a951?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm02', label: { en: 'Spring Hills', ar: 'تلال الربيع' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm03', label: { en: 'Sunny Meadow', ar: 'مرج مشمس' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm04', label: { en: 'Mist Mountains', ar: 'جبال ضباب' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm05', label: { en: 'Clear Lake', ar: 'بحيرة صافية' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm06', label: { en: 'Bamboo Grove', ar: 'غابة خيزران' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm07', label: { en: 'Forest Rays', ar: 'أشعة الغابة' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm08', label: { en: 'Blue Horizon', ar: 'أفق أزرق' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm09', label: { en: 'Soft Clouds', ar: 'غيوم ناعمة' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1534088568595-a066f410bc3a?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm10', label: { en: 'Green Peaks', ar: 'قمم خضراء' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm11', label: { en: 'Flower Field', ar: 'حقل زهور' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1462275646964-a0e3386b89fa?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm12', label: { en: 'River Light', ar: 'نهر مضيء' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1433086966358-54857c70c22b?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm13', label: { en: 'Pastel Dawn', ar: 'فجر باستيل' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm14', label: { en: 'Warm Gradient', ar: 'تدرج دافئ' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1557683316-973673baf926?w=1600&q=90&auto=format&fit=crop' },
  { id: 'm15', label: { en: 'Peach Sky', ar: 'سماء خوخية' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1600&q=90&auto=format&fit=crop' },

  /* —— ليل أنمي —— */
  { id: 'n01', label: { en: 'Star Lake', ar: 'بحيرة النجوم' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n02', label: { en: 'Moon Forest', ar: 'غابة القمر' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1511497584788-876760111969?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n03', label: { en: 'Galaxy', ar: 'مجرة' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n04', label: { en: 'Purple Night', ar: 'ليل بنفسجي' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1507400492013-162706c8c05e?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n05', label: { en: 'Aurora', ar: 'شفق' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n06', label: { en: 'Dark Sea', ar: 'بحر مظلم' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1505144808419-1957a94ca61e?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n07', label: { en: 'Rain City', ar: 'مدينة ممطرة' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n08', label: { en: 'Tokyo Night', ar: 'طوكيو ليل' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n09', label: { en: 'Sunset Glow', ar: 'توهج الغروب' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n10', label: { en: 'Snow Night', ar: 'ليلة ثلج' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1483664852095-d6cc6870604d?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n11', label: { en: 'Blue Hour', ar: 'الساعة الزرقاء' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n12', label: { en: 'Night Neon', ar: 'نيون' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n13', label: { en: 'Deep Space', ar: 'فضاء عميق' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1464802686167-b939a6910659?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n14', label: { en: 'Twilight Peak', ar: 'قمة الغسق' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1507400492013-162706c8c05e?w=1600&q=90&auto=format&fit=crop' },
  { id: 'n15', label: { en: 'Silent Night', ar: 'ليل هادئ' }, type: 'img',
    url: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=1600&q=90&auto=format&fit=crop' }
]
